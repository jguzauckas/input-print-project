...
print("Each person should have a starting balance between 5k and 10k.")
per1 = float(input("Enter person 1's starting balance: "))
per2 = float(input("Enter person 2's starting balance: "))
print("Person 1 has", per1, "dollars and Person 2 has", per2, "dollars.")
...
per1 += 1422.76
per2 += 1546.98
print("After pay day, Person 1 has", per1, "dollars and Person 2 has", per2, "dollars.")
...
per1 -= 324.59
per2 -= 287.68
print("After errands, Person 1 has", per1, "dollars and Person 2 has", per2, "dollars.")
...
per1 *= 3
per2 *= 3
print("After the fair, Person 1 has", per1, "dollars and Person 2 has", per2, "dollars.")
...
per1 /= 2
per2 /= 2
print("After a couple weeks, Person 1 has", per1, "dollars and Person 2 has", per2, "dollars.")
...
per1 //= 1.5
per2 //= 1.5
print("After the error, Person 1 has", per1, "dollars and Person 2 has", per2, "dollars.")
...
per1 *= (rate1 ** 50)
per2 *= (rate2 ** 50)
print("After 50 years, Person 1 has", per1, "dollars and Person 2 has", per2, "dollars.")
...
per1 %= 5
per2 %= 10
print("After they distribute the money, Person 1 has", per1, "dollars and Person 2 has", per2, "dollars.")